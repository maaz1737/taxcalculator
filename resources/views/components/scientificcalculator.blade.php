...
<div id="sciCalcModal"
    ...
    <div class="relative z-10 w-[min(700px,90vw)] max-h-[90vh] rounded-2xl shadow-2xl ring-1 ring-slate-200/60 dark:ring-slate-700/60 bg-white dark:bg-gray-900 overflow-hidden transform scale-95 transition-transform duration-300">
        ...
        <!-- Header -->
        <div class="flex items-center justify-between px-5 py-3 bg-gray-100/70 dark:bg-gray-800/70 backdrop-blur border-b border-slate-200 dark:border-slate-800 sticky top-0">
            <div class="flex items-center gap-2">
                <h1 id="sciCalcTitle" class="text-base font-semibold text-gray-900 dark:text-white">
            ...
            <div class="flex items-center gap-2">
                ...
                <button id="closeSciCalc"
                    class="ml-1 inline-flex items-center justify-center h-8 w-8 rounded-full text-gray-600 hover:text-gray-900 hover:bg-gray-200/70 dark:text-gray-300 dark:hover:text-gray-100 dark:hover:bg-gray-700/70 focus:outline-none focus:ring-2 focus:ring-slate-300 dark:focus:ring-slate-600"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-3 p-4 overflow-y-auto max-h-[70vh]">
            ...
            <div class="lg:col-span-3 grid grid-cols-5 gap-1.5 text-sm">
                ...
                <button data-key="7" class="btn bg-white dark:bg-gray-800">7</button>
                <button data-key="8" class="btn bg-white dark:bg-gray-800">8</button>
                <button data-key="9" class="btn bg-white dark:bg-gray-800">9</button>
                ...
                <button data-key="4" class="btn bg-white dark:bg-gray-800">4</button>
                <button data-key="5" class="btn bg-white dark:bg-gray-800">5</button>
                <button data-key="6" class="btn bg-white dark:bg-gray-800">6</button>
                <button data-op="*" class="btn bg-slate-100 dark:bg-gray-800">×</button>
                <button data-op="-" class="btn bg-slate-100 dark:bg-gray-800">−</button>

                <button data-key="1" class="btn bg-white dark:bg-gray-800">1</button>
                <button data-key="2" class="btn bg-white dark:bg-gray-800">2</button>
                <button data-key="3" class="btn bg-white dark:bg-gray-800">3</button>
                <button data-op="+" class="btn bg-slate-100 dark:bg-gray-800">+</button>
                <button data-op="^" class="btn bg-slate-100 dark:bg-gray-800">^</button>

                <button data-key="0" class="col-span-2 btn bg-white dark:bg-gray-800">0</button>
                <button data-key="." class="btn bg-white dark:bg-gray-800">.</button>
