<x-app
    :title="'France Time Now – Current Time in Paris | Live France Time Zone Converter'"
    :titleTwitter="'France Time Now – Live Paris Time'"
    :des="'Check the current time in France (Paris) with our live online clock. View France local time, compare your time zone with Paris, and convert your local time to France time instantly and accurately.'"
    :key="'France time now, current time in Paris, Paris time now, France timezone, France local time, time in Paris, France time converter, live France clock, France time difference, world clock Paris, Europe/Paris time, Central European Time, convert local time to France, online France time zone converter'" />
...
<div class="bg-emerald-50 text-black dark:bg-slate-900 text-white">
    <div class="w-full min-h-[70vh] py-10 flex flex-col lg:flex-row items-center justify-center gap-16 text-center">
        ...
        <div
            class="bg-yellow-50 backdrop-blur-xl p-6 rounded-2xl shadow-xl border border-yellow-300 w-[320px] dark:bg-slate-600/50 dark:border-slate-700">
            <h3 class="text-xl font-bold text-emerald-800 dark:text-gray-200 mb-4">France 🇫🇷 (Paris)</h3>
            <div class="dial" id="france-dial"></div>

            <div class="mt-4 text-emerald-800 dark:text-white space-y-1">
                <p id="france-day" class="font-bold"></p>
                <p id="france-date"></p>
                <p id="france-time" class="text-xl font-semibold"></p>
            </div>
        </div>
    ...
    <div
        ...
        <h2 class="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">About France Current Time (Paris Time)</h2>

        <p class="text-gray-800 leading-relaxed mb-4 dark:text-gray-200">
            The <strong>current time in France</strong> follows <strong>Central European Time (CET, UTC+1)</strong> during winter and
            <strong>Central European Summer Time (CEST, UTC+2)</strong> during summer. The capital city, Paris, follows this same time zone.
        </p>

        <p class="text-gray-800 leading-relaxed mb-4 dark:text-gray-200">
            Our live France clock shows the <strong>time in Paris</strong> updated every second. This tool helps you compare
            <strong>France time vs your local time</strong>, perfect for travelers, business professionals, or anyone working with French partners.
        </p>

        <p class="text-gray-800 leading-relaxed dark:text-gray-200">
            Whether you’re scheduling meetings, planning a trip, or coordinating online work, you can use this
            <strong>live France time converter</strong> to check the current date, day, and exact time in Paris instantly.
        </p>
    </div>
</div>
