<x-app
    :title="'China Time Now – Current Time in China (Beijing) | Live China Time Converter'"
    :titleTwitter="'China Time Now – Live Beijing Time'"
    :des="'Check the current time in China (Beijing) with our live online clock. View China local time, compare your time zone with Beijing, see China daylight saving rules, and convert your local time instantly.'"
    :key="'China time now, current time in China, Beijing time now, China timezone, China local time, time in Beijing, China time converter, live China clock, China time difference, world clock China, Asia/Shanghai time, Beijing time now, convert local time to China, online China time zone converter'" />
...
<div class="bg-emerald-50 text-black dark:bg-slate-900 text-white">
    <div class="w-full min-h-[70vh] py-10 flex flex-col lg:flex-row items-center justify-center gap-16 text-center">
        ...
        <div class="bg-yellow-50 backdrop-blur-xl p-6 rounded-2xl shadow-xl border border-yellow-300 w-[320px] dark:bg-slate-600/50 dark:border-slate-700">
            <h3 class="text-xl font-bold text-emerald-800 dark:text-gray-200 mb-4">China 🇨🇳 (Beijing)</h3>
            <div class="dial" id="cn-dial"></div>

            <div class="mt-4 text-emerald-800 dark:text-white space-y-1">
                <p id="cn-day" class="font-bold"></p>
                <p id="cn-date"></p>
                <p id="cn-time" class="text-xl font-semibold"></p>
            </div>
        </div>
    ...
    <div class="w-full max-w-3xl mx-auto mt-12 p-6 bg-yellow-100/30 rounded-xl shadow border border-yellow-300 dark:text-gray-100 dark:bg-slate-600/50 dark:border-slate-700/40">
        <h2 class="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">About China Current Time (Beijing Time)</h2>

        <p class="text-gray-800 leading-relaxed mb-4 dark:text-gray-200">
            China operates on China Standard Time (CST), which is UTC +08:00. The country does not observe daylight saving time, making <strong>China time now</strong> consistent throughout the year. Use this tool to instantly check the <strong>current time in China (Beijing)</strong> with accurate, real-time results.
        </p>

        <p class="text-gray-800 leading-relaxed mb-4 dark:text-gray-200">
            China time is widely used for business, international trading, online meetings, travel planning, and coordinating with family or friends in Beijing. Compare <strong>China time vs your local time</strong> to avoid scheduling conflicts across time zones.
        </p>

        <p class="text-gray-800 leading-relaxed dark:text-gray-200">
            This tool converts your local time to <strong>Beijing time</strong> instantly and provides the current day, date, and exact time. Perfect for online workers, travelers, and global teams.
        </p>
    </div>
</div>
<x-appfooter />
