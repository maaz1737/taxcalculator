<x-app
    title="Current Time in Turkey - Istanbul Now"
    key="View current time in Turkey and Istanbul now. Compare Turkey time with your local timezone using our instant online converter. Turkey Time (TRT) live clock."
    des="Check Turkey time now instantly with our live Istanbul clock and time converter. Compare time zones, convert local time to Turkey TRT, and see the difference."
    titleTwitter="Current Time in Turkey Now - Istanbul" />
...
<div class="bg-emerald-50 text-black dark:bg-slate-900 dark:text-white">
    ...
    <div class="w-full min-h-[70vh] py-10 flex flex-col lg:flex-row items-center justify-center gap-16 text-center">
        ...
        <div class="bg-yellow-50 backdrop-blur-xl p-6 rounded-2xl shadow-xl border border-yellow-300 w-[320px] dark:bg-slate-600/50 dark:border-slate-700">
            ...
            <div class="dial" id="tr-dial"></div>

            <div class="mt-4 text-emerald-800 dark:text-white space-y-1">
                <p id="tr-day" class="font-bold"></p>
                <p id="tr-date"></p>
                <p id="tr-time" class="text-xl font-semibold"></p>
            </div>
        </div>
    ...
    <div class="w-full max-w-3xl mx-auto mt-12 p-6 bg-yellow-100/30 rounded-xl shadow border border-yellow-300 dark:text-gray-100 dark:bg-slate-600/50 dark:border-slate-700/40">
        <h2 class="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">
            About Turkey Current Time
        </h2>

        <p class="text-gray-800 leading-relaxed mb-4 dark:text-gray-200">
            Turkey follows Turkey Standard Time (TRT), which is UTC +3.
            Turkey does not observe daylight saving time, so the time remains constant throughout the year.
        </p>

        <p class="text-gray-800 leading-relaxed mb-4 dark:text-gray-200">
            Knowing the current time in Istanbul is useful for international business, online meetings, travel planning, and communication with people living in Turkey.
            This live clock updates in real time to give you the most accurate Turkey time.
        </p>

        <p class="text-gray-800 leading-relaxed dark:text-gray-200">
            Use this tool to check Turkey time now, compare it with your local time, or instantly convert your local time to Istanbul time.
        </p>
    </div>
</div>
