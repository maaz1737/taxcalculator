<x-app
    title="Current Time in Qatar - Doha Time Now"
    key="View current time in Qatar and Doha now. Compare Qatar time with your local timezone using our instant online converter. Arabia Standard Time (AST) live clock."
    des="Check Qatar time now instantly with our live Doha clock and time converter. Compare time zones, convert local time to Qatar AST, and see the difference."
    titleTwitter="Current Time in Qatar Now - Doha Clock" />
...
<div class="bg-emerald-50 text-black dark:bg-slate-900 dark:text-white">
    ...
    <div class="w-full min-h-[70vh] py-10 flex flex-col lg:flex-row items-center justify-center gap-16 text-center">
        ...
        <div class="bg-yellow-50 backdrop-blur-xl p-6 rounded-2xl shadow-xl border border-yellow-300 w-[320px] dark:bg-slate-600/50 dark:border-slate-700">
            ...
            <div class="dial" id="qa-dial"></div>

            <div class="mt-4 text-emerald-800 dark:text-white space-y-1">
                <p id="qa-day" class="font-bold"></p>
                <p id="qa-date"></p>
                <p id="qa-time" class="text-xl font-semibold"></p>
            </div>
        </div>
    ...
    <div class="w-full max-w-3xl mx-auto mt-12 p-6 bg-yellow-100/30 rounded-xl shadow border border-yellow-300 dark:text-gray-100 dark:bg-slate-600/50 dark:border-slate-700/40">
        <h2 class="text-2xl font-bold text-gray-900 mb-4 dark:text-gray-100">
            About Qatar Current Time
        </h2>

        <p class="text-gray-800 leading-relaxed mb-4 dark:text-gray-200">
            Qatar follows Arabia Standard Time (AST), which is UTC +3 and does not observe daylight saving time.
            This means Qatar time remains consistent throughout the year.
        </p>

        <p class="text-gray-800 leading-relaxed mb-4 dark:text-gray-200">
            Knowing the correct time in Qatar is helpful for international business meetings,
            online calls, travel planning, and communication with people living in Doha and other cities of Qatar.
            This live clock updates in real time to give you the most accurate Qatar time now.
        </p>

        <p class="text-gray-800 leading-relaxed dark:text-gray-200">
            Use this tool to check the current time in Qatar, compare it with your local time,
            or instantly convert your time to match Qatar's timezone.
        </p>
    </div>
</div>
